  ...
  return (
    <div className="w-full h-full flex elementScreen" id='Project'>
        <div className="h-full w-full">
            <div className="h-[90vh] sm:h-[90%] w-[95%] grid auto-rows-[90vh] sm:grid-cols-2 sm:grid-rows-2 grid-flow-row sm:grid-flow-col m-auto overflow-y-scroll sm:overflow-hidden">
